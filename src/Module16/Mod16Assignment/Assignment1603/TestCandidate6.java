 ...
 * @author Tyler
 * @version 3/19/2017
 * @purpose Practice Insertion algorithm.
 */
public class TestCandidate6
    {
        ...
        public static void insertPosition(List<Candidate3> election, int position, String Nname, int votes)
            {
                election.add(position - 1, new Candidate3(Nname, votes));
            }

        public static void insertCandidate(List<Candidate3> election, String candidate, String newName, int votes)
            {
                int location = 0;
                ...
                election.add(location, new Candidate3(newName, votes));
            }
    }
