package Module13.Mod13Assignments.Assignment1305;
...
public class Magpie4
{
    ...
    public String getResponse(String statement)
    {
        ...
        else
        {
            ...
            if (position2 >= 0 && findKeyword(statement, "you", position2) >= 0)
                {
    ...
    private String getRandomResponse()
    {
        ...
        else if (whichResponse == 3)
        {
            ...
            {
                response = "How about that, anything else?";
            }
        else if (whichResponse == 5)
            {
                response = "Got anything else?";
            }
