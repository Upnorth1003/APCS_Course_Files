package Module06.Mod06Lessons.OutputFormation602;
/**
...
public class FormattingStrings
{
    public static void main(String [] args)
    {
        ...
        System.out.println();
        System.out.printf("%S", argument1); //uppercase makes whole uppercase
        System.out.println();
        System.out.println();
        ...
        System.out.println(".........1.........2.........3.........4.........5");
        System.out.printf("%15s\n", argument1);//right justified
        System.out.printf("%-15s\n", argument1);//left justified
        System.out.println();
